 ...
 const handleBidding = async () => {
  try {
    ...
    const handleProjectSubmission = async() =>{
      ...
      await axios.post("http://localhost:6001/submit-project", {clientId, freelancerId, projectId, projectLink, manualLink, submissionDescription}, { headers: { Authorization: `Bearer ${token}` } }).then(
        (response)=>{
            setProjectLink('');
            setManualLink('');
                ...
                <div className="project-form-body">
                  ...
                  <span>
                      <div className="form-floating">
                        <input type="number" className="form-control mb-3" id="floatingPassword" placeholder="Budget" value={bidAmount} onChange={(e)=>setBidAmount(e.target.value)} />
                        <label htmlFor="floatingPassword">Budget</label>
                      </div>
                      <div className="form-floating">
                        <input type="number" className="form-control mb-3" id="floatingPassword" placeholder="Time" value={estimatedTime} onChange={(e)=>setEstimatedTime(e.target.value)} />
                        <label htmlFor="floatingPassword">Estimated time (days)</label>
                      </div>
                  </span>
                  <div className="form-floating">
                        <textarea className="form-control mb-3" id="floatingPassword" placeholder="Describe" value={proposal} onChange={(e)=>setProposal(e.target.value)}/>
